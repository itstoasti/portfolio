...
import { words, SITE_SETTINGS } from "@/src/lib/constants";
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <div>
              ...
              <div className="flex items-center justify-between gap-4">
                ...
                />
                {SITE_SETTINGS.showSocialLinks && SITE_SETTINGS.socialLinks && (
                  <div className="flex items-center gap-2 sm:gap-3">
                    {SITE_SETTINGS.socialLinks.map((link: any) => {
                      ...
                      const Icon = IconMap[link.icon] || FaPaperclip;
                        ...
                        <Tooltip key={link.id}>
                          <TooltipTrigger asChild>
                            <Link 
                              ...
                              className="p-2 rounded-full hover:bg-foreground/5 hover:text-muted-foreground text-foreground transition-all duration-200"
                            >
          ...
          >
            <p className="text-muted-foreground my-6 text-md lg:text-lg max-w-2xl leading-relaxed">
              Astronaut, Accountant, Doctor, Lawyer, Investment Banker and CEO - I'm none of these things. I like building stuff online though.
            </p>
