  ...
  return (
    <div className="w-full max-w-3xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-2 md:gap-4 pt-4 lg:pt-8">
        ...
        {/* Top Right - Skills */}
        <div className={`bg-card rounded-xl shadow-md border border-edge overflow-hidden flex items-center justify-center min-h-[140px] md:min-h-[180px] ${SITE_SETTINGS.showUiLibrary ? 'md:col-span-2' : 'md:col-span-3'}`}>
          <SkillsCarousel />
        </div>
